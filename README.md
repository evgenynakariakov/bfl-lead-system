...
BFL Lead System — проект системы для поиска, оценки и первичной квалификации лидов.
Логика простая: система собирает объявления, считает score, готовит персональное первое сообщение с deep-link на бота, проводит квалификацию в Telegram, сохраняет результат в PostgreSQL и показывает данные в дашборде.
